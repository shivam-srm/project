...
def def_start():
    ...
    pdfb = Button(window, text="GENERATE PDF", command=def_PDF, font=("Poppins", 20), bg="red", fg="blue", borderwidth=3, relief="raised")
...
startb = Button(window, text="START", command=def_start, font=("Arial", 30), bg="light blue", fg="black", borderwidth=3, relief="raised")
startb.place(x=110, y=580)
...
# Start button created to run the main window
